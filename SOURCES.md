...
This document lists the verifiable sources behind statistics, data points, and factual claims used across Financially Sovereign Academy. Per our content policy, every quantitative claim must trace to a named, verifiable source.
...
## Credit Scores & Credit System

### FICO Score Composition
**Claim:** Payment history = 35%, Amounts owed = 30%, Length of history = 15%, New credit = 10%, Credit mix = 10%  
...
**Claim:** FICO scores range from 300 (poor) to 850 (exceptional)  
**Source:** myFICO — Credit Score Ranges  
**URL:** https://www.myfico.com/credit-education/credit-scores

### Free Annual Credit Reports
**Claim:** AnnualCreditReport.com is the only federally mandated source for free credit reports from all 3 bureaus  
**Source:** Federal Trade Commission (FTC) — Fair Credit Reporting Act (FCRA)  
**URL:** https://www.annualcreditreport.com | https://www.ftc.gov/legal-library/browse/statutes/fair-credit-reporting-act

### Credit Dispute Timeline
**Claim:** Credit bureaus have 30 days to investigate a dispute  
...
### Mortgage Rate Impact of Credit Score
**Claim:** A 760 vs. 620 credit score can mean $100,000+ difference in interest on a 30-year mortgage  
**Source:** myFICO Loan Savings Calculator (illustrative — actual savings vary by loan amount, rate environment, and lender)  
**URL:** https://www.myfico.com/credit-education/calculators/loan-savings-calculator/  
**Note:** Verify with current rates before citing specific dollar figures.
...
**Claim:** FDIC insures deposits up to $250,000 per depositor, per insured bank, per ownership category  
...
### Household Financial Resilience ($400 Emergency Expense)
**Claim:** Many households cannot cover a $400 unexpected expense without borrowing or selling something  
**Source:** Federal Reserve — Report on the Economic Well-Being of U.S. Households (SHED)  
**URL:** https://www.federalreserve.gov/consumerscommunities/shed.htm

### Personal Savings Rate
**Source:** U.S. Bureau of Economic Analysis (BEA) — Personal Saving Rate (PSAVERT)  
...
**Source:** Robert Shiller (Yale) — Online Data  
**URL:** http://www.econ.yale.edu/~shiller/data.htm

### Expense Ratio & Fee Disclosure
**Source:** SEC — Mutual Fund Fee Calculator  
**URL:** https://www.sec.gov/investor/tools/mfcc/mfcc-int.htm
...
|-------|----------|--------|
| "80% of people who try [budgeting] give up within 3 months" | `modules/money-mindset-cash-flow.html` | [SOURCE NEEDED] |
...
1. Find the primary source (government data, peer-reviewed research, or authoritative organization)
